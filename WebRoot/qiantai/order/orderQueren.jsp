					...
					<div class="Slot">
						<form action="<%=path %>/orderSubmit.action" name="f" method="post">
		        				...
		        				<table>
				                   ...
				                   <tr>
				                       <td><a href="#" onclick="back1()"><input type="submit" value="返回" style="border:#ccc 1px solid; background-color:#FFFFFF; font-size:12px; padding-top:3px;padding-right:3px;padding-left:3px;padding-bottom:3px;"/></a></td>
				                       <td><input type="submit" value="提交订单" onclick="javascript:document.f.submit();" style="border:#ccc 1px solid; background-color:#FFFFFF; font-size:12px; padding-top:3px;padding-right:3px;padding-left:3px;padding-bottom:3px;"/></td>
				                   </tr>
				               </table>
				        </form>
                    </div>
