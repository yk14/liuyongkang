					...
					<div class="Slot">
						<s:set name="items" value="#session.cart.items"/>
	        				...
	        				<table>
			                   ...
			                   <tr>
			                       <td width="120"></td>
			                       <td>&nbsp;&nbsp;&nbsp;<a href="#" onclick="clearCart()"><input type="submit" value="清空" style="border:#ccc 1px solid; background-color:#FFFFFF; font-size:12px; padding-top:3px;padding-right:3px;padding-left:3px;padding-bottom:3px;"/></a></td>
			                       <td>&nbsp;&nbsp;&nbsp;<a href="<%=path %>/qiantai/default.jsp"><input type="submit" value="继续购物" style="border:#ccc 1px solid; background-color:#FFFFFF; font-size:12px; padding-top:3px;padding-right:3px;padding-left:3px;padding-bottom:3px;"/></a></td>
			                       <td>&nbsp;&nbsp;&nbsp;<a href="<%=path %>/orderQueren.action"><input type="submit" value="下一步" style="border:#ccc 1px solid; background-color:#FFFFFF; font-size:12px; padding-top:3px;padding-right:3px;padding-left:3px;padding-bottom:3px;"/></a></td>
			                   </tr>
			               </table>
                    </div>
				</div>
