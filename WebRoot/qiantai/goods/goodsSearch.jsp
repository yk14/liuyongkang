						...
						<table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
				              <tr align="center" bgcolor="#FAFAF1" height="22">
								  ...
								  <tr align='center' bgcolor="#FFFFFF" height="22">
									  ...
									  <td><a href="<%=path %>/goodsDetail.action?goodsId=<s:property value="#goods.goodsId"/>"><input type="submit" value="购买" style="border:#ccc 1px solid; background-color:#FFFFFF; font-size:12px; padding-top:3px;padding-right:3px;padding-left:3px;padding-bottom:3px;"/><input type="hidden" name="goodsId" value="<s:property value="#request.goods.goodsId"/>"/></a></td>
								  </tr>
								  </s:iterator>
	        			</table>
                    </div>
