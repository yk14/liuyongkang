				...
				<div class="NewContainer771">
					...
					<div class="Slot">
						...
						<table width="100%" border="0">
						    ...
						    <tr>
						       <td align="center"><input type="hidden" name="goodsId" value="<s:property value="#request.goods.goodsId"/>"/><input type="submit" value="购买" style="border:#ccc 1px solid; background-color:#FFFFFF; font-size:12px; padding-top:3px;padding-right:3px;padding-left:3px;padding-bottom:3px;" onclick="buy1()"/><hr/></td>
						    </tr>
						</table>
						</form>
                    </div>
