    ...
    <div class="body-box">
		...
		<table border="0">
		     ...
		     <tr>
		         ...
		         <td>
		         	 <input type="text" name="liuyanContent" size="50"/>
		          <!-- <FCK:editor instanceName="liuyanContent"  basePath="/fckeditor" width="500" height="200" value="请输入内容" toolbarSet="Basic"> </FCK:editor>-->    
